...
#    Source File: https://github.com/deepfakes/faceswap/blob/v1.0.0/faceswap.py
#    Licenses:
...
#    Source File: https://github.com/healthchecks/healthchecks/blob/v1.8.0/hc/api/management/commands/prunepingsslow.py
#    Licenses:
